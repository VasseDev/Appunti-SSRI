...
$$  
x\geq \sqrt{x}\geq\sqrt[4]{x}\rightarrow x\geq 1  
$$  
  
$$  
x\leq\sqrt{x}\leq\sqrt[4]{x}\rightarrow 0\leq x\leq 1  
$$  
Le radici pari sono sempre $\geq 0$  
...
a>0,a\neq1\text{ e }y>0  
$$  
esiste un unico reale $x$ tale che  
$$  
a^x=y  
$$  
si dice che  
...
$$  
\log_a(x)\geq0\rightarrow x\geq1  
$$  
$$  
\log_a(x)\leq0\rightarrow0<x\leq1  
$$  
...
$$  
\log_a(x)\geq0\rightarrow 0<x\leq1  
$$  
$$  
\log_a(x)\leq0\rightarrow x\geq1  
$$  
...
**Relazioni utili per le equazioni**  
$$  
a^{\log_a(x)}=x\text{ se }x>0  
$$  
$$  
\log_a(a^x)=x\quad\forall\space x\in\mathbb{R}  
$$  
...
$$  
$$  
21^x\cdot\frac{1}{21}=15^x  
$$  
$$  
\frac{1}{21}=15^x\cdot\left(\frac{1}{21}\right)^{x}  
$$  
$$  
\frac{1}{21}=\left(\frac{5}{7}\right)^x  
$$  
$$  
x=\log_{\frac{5}{7}}\left(\frac{1}{21}\right)  
$$  
...
$$  
e^x=2\pm\sqrt{3}\rightarrow\ln(e^x)=\ln(2\pm\sqrt{3})  
$$  
$$  
x_{1,2}=\ln(2\pm\sqrt{3})  
$$  
$$  
...
$$  
$$  
\text{sol} = \left(0,\frac{1}{24}\right]  
$$  
  
2.   
  
$$  
\log_3(x+1)>\log_9(2x+3)  
$$  
mi riduco alla stessa base  
$$  
log_9(2x+3)=\frac{\log_3(2x+3)}{\log_3(9)}=\frac{\log_3(2x+3)}{2}  
$$  
$$  
\log_3(x+1)>\frac{\log_3(2x+3)}{2}  
$$  
$$  
2\log_3(x+1)>\log_3(2x+3)  
$$  
c.e.  
$$  
\begin{cases}  
